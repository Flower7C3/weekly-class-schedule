...
<form id="wcs4-lessons-filter" class="results-filter" method="get" action="">
    ...
    <div class="search-box">
        <div class="alignleft">
            <label for="search_wcs4_lesson_subject_id">
                <?= __('Subject', 'wcs4') ?>
            </label>
        ...
        <div class="alignleft">
            <label for="search_wcs4_lesson_teacher_id">
                <?= __('Teacher', 'wcs4') ?>
            </label>
            <?= Admin::generate_admin_select_list(
                'teacher',
        ...
        <div class="alignleft">
            <label for="search_wcs4_lesson_student_id">
                <?= __('Student', 'wcs4') ?>
            </label>
            <?= Admin::generate_admin_select_list(
                'student',
        ...
        <div class="alignleft">
            <label for="search_wcs4_lesson_classroom_id">
                <?= __('Classroom', 'wcs4') ?>
            </label>
            <?= Admin::generate_admin_select_list(
                'classroom',
