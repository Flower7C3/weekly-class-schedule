...
<form id="wcs4-progresses-filter" class="results-filter" method="get" action="">
    ...
    <div class="search-box">
        <fieldset class="alignleft">
            ...
            <div class="alignleft">
                <label class="screen-reader-text" for="search_wcs4_progress_subject_id">
                    <?= __('Subject', 'wcs4') ?>
                </label>
        ...
        <fieldset class="alignleft">
            ...
            <div class="alignleft">
                <label class="screen-reader-text" for="search_wcs4_progress_teacher_id">
                    <?= __('Teacher', 'wcs4') ?>
                </label>
                <?= Admin::generate_admin_select_list(
                    'teacher',
        ...
        <fieldset class="alignleft">
            ...
            <div class="alignleft">
                <label class="screen-reader-text" for="search_wcs4_progress_student_id">
                    <?= __('Student', 'wcs4') ?>
                </label>
                <?= Admin::generate_admin_select_list(
                    'student',
        ...
        <fieldset class="alignleft">
            ...
            <div class="alignleft">
                <label class="screen-reader-text" for="search_wcs4_progress_type">
                    <?= __('Type', 'wcs4') ?>
                </label>
        ...
        <fieldset class="alignleft">
            ...
            <div class="alignleft">
                <label class="screen-reader-text" for="search_wcs4_progress_date_from">
                    <?= __('Date from', 'wcs4') ?>
                </label>
            ...
            <div class="alignleft">
                <label class="screen-reader-text" for="search_wcs4_progress_date_upto">
                    <?= __('Date to', 'wcs4') ?>
                </label>
                <?= Admin::generate_date_select_list(
        ...
        <fieldset class="alignleft">
            ...
            <div class="alignleft">
                <label class="screen-reader-text" for="search_wcs4_progress_created_at_from">
            ...
            <div class="alignleft">
                <label class="screen-reader-text" for="search_wcs4_progress_created_at_upto">
