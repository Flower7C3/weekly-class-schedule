...
?>
<div class="wcs4-form-wrap wcs4-management-form-wrapper" id="wcs4-work-plan-form-wrapper">
    <h2 data-wcs4="management-form-title"><?= _x('Add New Work Plan', 'page title', 'wcs4') ?></h2>
    <form id="wcs4-work-plan-form" class="czr-form" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
        <fieldset class="form-field form-required form-field-type-wrap">
            <label for="wcs4_work_plan_type"><?= __('Type', 'wcs4') ?></label>
        ...
        if (empty($subject)): ?>
            <fieldset class="form-field form-required form-field-subject_id-wrap" style="display: none;">
                <label for="wcs4_work_plan_subject_id"><?= __('Subject', 'wcs4') ?></label>
        ...
        <?php
            ...
            <input type="hidden" id="wcs4_work_plan_subject" name="subject" value="<?= $subject ?>"/>
        <?php
        endif; ?>
        <?php
        if (empty($teacher)): ?>
            <fieldset class="form-field form-required form-field-teacher_id-wrap" style="display: none;">
                <label for="wcs4_work_plan_teacher_id"><?
                    __('Teacher', 'wcs4'); ?></label>
                <?= Admin::generate_admin_select_list(
                    'teacher',
        ...
        <?php
            ...
            <input type="hidden" id="wcs4_work_plan_teacher" name="teacher[]" value="<?= $teacher ?>"/>
        <?php
        endif; ?>
        <?php
        if (empty($student)): ?>
            <fieldset class="form-field form-required form-field-student_id-wrap" style="display: none;">
                <label for="wcs4_work_plan_student_id"><?= __('Student', 'wcs4') ?></label>
                <?= Admin::generate_admin_select_list(
                    'student',
        ...
        <fieldset class="form-field form-required form-field-start_date-wrap" style="display: none;">
            <label for="wcs4_work_plan_start_date"><?= __('Start date', 'wcs4') ?></label>
        ...
        <fieldset class="form-field form-required form-field-end_date-wrap" style="display: none;">
            <label for="wcs4_work_plan_end_date"><?= __('End date', 'wcs4') ?></label>
        ...
        <fieldset class="submit" id="wcs4_work_plan_buttons-wrapper">
            ...
            <button data-wcs4="reset-form" type="reset" class="button button-link wcs4-reset-work-plan-form"
                    style="display: none;">
