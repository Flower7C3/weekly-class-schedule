            ...
            if (empty($errors)) {
                ...
                try {
                    ...
                    ",
                        ...
                        $r = $wpdb->update($table, $data_schedule, array('id' => $row_id), array('%d', '%d', '%d', '%s', '%s', '%s', '%d', '%s',), array('%d'));
                        if (FALSE === $r) {
                        ...
                        $r = $wpdb->insert($table, $data_schedule, array('%d', '%d', '%d', '%s', '%s', '%s', '%d', '%s',));
                        if (FALSE === $r) {
