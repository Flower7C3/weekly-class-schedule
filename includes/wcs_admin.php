...
function wcs4_help_wcr_shortcode_callback()
{
    ...
    <h3>
        ...
        printf(
            _x(
                'To display all the reports in a single schedule, simply enter the shortcode <code>%1$s</code> inside a page or a post.',
                'help',
                'wcs4'
            ),
            '[wcr]'
    ...
    <p>
        <?php
        _ex(
            'In order to filter a report by a specific subject, teacher, student, or any other combination of the three, use the subject, student and teacher attributes.',
            'help',
            'wcs4'
        ); ?>
        <?php
...
function wcs4_help_placeholders_callback()
{
    ...
    <ul>
        <li>
            <?php
            printf(
                _x('Will display general info: <code>%1$s</code>', 'help', 'wcs4'),
                implode(
                    '</code>, <code>',
                    ['{schedule no}', '{date}', '{weekday}', '{start time}', '{end time}', '{notes}', '{topic}',]
                )
            ); ?>
        </li>
        <li>
...
class WCS_Admin
{
    ...
    {
        $layout = [
            'none' => _x('Do not display', 'Schedule layout as none', 'wcs4'),
